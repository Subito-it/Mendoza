struct Matcher {
    ...
    static let noSpaceOnDevice = Regex(pattern: .noSpaceOnDevice)
    static let checkingForCrashReports = Regex(pattern: .checkingForCrashReports)
    static let encounteredAnError = Regex(pattern: .encounteredAnError)
    static let encounteredAnSimulatorError = Regex(pattern: .encounteredAnSimulatorError)
    static let testingFailed = Regex(pattern: .testingFailed)
}
