...
class CodeCoverageCollectionOperation: BaseOperation<Coverage?> {
    ...
    override func main() {
        ...
        do {
            ...
            let coverageFiles = try destinationExecuter.execute(
            ...
            if let mergedPath = try coverageMerger.merge(coverageFiles: coverageFiles, strict: true) {
                ...
                let jsonCoverageUrl = try codeCoverageGenerator.generateJsonCoverage(
                    ...
                    pathEquivalence: pathEquivalence, strict: true
                )
                ...
                if coverage == nil { throw Error("Invalid final coverage summary") }
